    ...
    <div>
      ...
      <div className="flex py-[8px] px-[16px]">
        <div className="w-1/3 flex items-center">
          <a className="flex items-center" href="https://www.linkedin.com/games/queens/" target="_blank">
      ...
      <div className="flex justify-center bg-[#E0E0E0] py-2">
        <p className="text-[#747474]">Disclaimer: Not affiliated with the actual LinkedIn Queens Game</p>
      </div>
    </div>
  );
};
